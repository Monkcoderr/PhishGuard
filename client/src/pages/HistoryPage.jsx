            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-6 mb-8 md:mb-12">
                <div>
                    <h1 className="text-2xl md:text-3xl font-black text-gray-900 flex items-center gap-3">
                        <HistoryIcon size={28} /> Scan Vault
                    </h1>
                ...
                <div className="flex w-full md:w-auto items-center gap-2 md:gap-3">
                    ...
                    <Button variant="secondary" size="sm" icon={<Filter size={14} />} className="shrink-0">Filter</Button>
                </div>
            </div>
                                ...
                                <GlassCard padding="none" hover className="group overflow-hidden">
                                    <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-4 p-4 md:p-6">
                                        ...
                                        <div className="col-span-4">
                                            ...
                                            <p className="text-xs text-gray-500 mt-0.5 truncate md:max-w-[250px]">
                                        ...
                                        {/* Actions */}
                                        <div className="col-span-1 flex justify-start md:justify-end gap-2">
