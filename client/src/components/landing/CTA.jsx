    ...
    return (
        <section className="py-16 md:py-24">
            <div className="container mx-auto px-4">
                <div className="glass-card bg-brand-dark/5 p-6 sm:p-10 md:p-20 relative overflow-hidden rounded-[24px] md:rounded-[32px] border-none text-center">
                    <div className="relative z-10 max-w-2xl mx-auto">
                        <GradientText className="text-3xl sm:text-4xl md:text-5xl font-black mb-6 tracking-tight">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                            <Link to="/register">
                                <Button size="lg" className="w-full md:w-auto px-8 md:px-10">Start for Free <ArrowRight size={18} /></Button>
                            </Link>
